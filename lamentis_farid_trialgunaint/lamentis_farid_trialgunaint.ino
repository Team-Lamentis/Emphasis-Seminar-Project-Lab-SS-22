...
String KeretaBaru[] ={"KeretaBaru1","KeretaBaru2","KeretaBaru3","KeretaBaru4","KeretaBaru5"};
                       ...
                       if(uxQueueMessagesWaiting(Car_Queue) == 0)
                        {
                           ...
                           //xQueueSend(Car_Queue,&carNew,10000;
                           //xQueueReceive(Car_Queue,&b,0);
                           //vTaskDelay(1000 / portTICK_PERIOD_MS);
                           //Serial.println(b);
                           //vTaskDelay(1000 / portTICK_PERIOD_MS);
                           //Serial.println("keretabaru");                       
